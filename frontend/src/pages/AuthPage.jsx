    ...
    <div className="auth-container">
      <div className="auth-left">
        <div className="auth-hero">
          <div className="brand-container">
            <img src="/logo.png" alt="Connectly" className="brand-logo" />
            <span className="brand-name">Connectly</span>
          </div>

          <h1 className="hero-title">Bringing Work to Life ✨</h1>
      ...
      <div className="auth-right">
        <div className="auth-image-container">
          <img src="/auth-icon.png" alt="Team collaboration" className="auth-image" />
